...
<DocVersionSwitcher versions={{
    agpl: {
        name: "AGPL",
        path: "../../3.0/tutorial/adding-extensions",
    },
    bsd: {
        name: "BSD",
        path: "../../3.0-bsd/tutorial/adding-extensions",
    },
}} active="agpl" />
...
```js title="scratch-editor/packages/scratch-vm/src/extensions/tutorialmod_dialogs/index.js"
...
```js title="scratch-editor/packages/scratch-vm/src/extension-support/extension-manager.js"
