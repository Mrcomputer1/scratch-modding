...
<DocVersionSwitcher versions={{
    agpl: {
        name: "AGPL",
        path: "../../../3.0/tutorial/getting-started/structure-of-scratch",
    },
    bsd: {
        name: "BSD",
        path: "../../../3.0-bsd/tutorial/getting-started/structure-of-scratch",
    },
}} active="agpl" />
...
[`scratch-gui`](https://github.com/scratchfoundation/scratch-editor/tree/develop/packages/scratch-gui) is the _main_ package of Scratch. It brings together all the other packages and contains most of the user interface of Scratch.
