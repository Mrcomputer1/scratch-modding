...
<DocVersionSwitcher versions={{
    agpl: {
        name: "AGPL",
        path: "../../../3.0/tutorial/first-scratch-mod/adding-a-block",
    },
    bsd: {
        name: "BSD",
        path: "../../../3.0-bsd/tutorial/first-scratch-mod/adding-a-block",
    },
}} active="agpl" />
...
```ts title="scratch-blocks/src/blocks/looks.ts"
// highlight-start
...
| File                              | Download                                                       |
| --------------------------------- | -------------------------------------------------------------- |
| `i18n/js_to_json.js`              | [js_to_json.js](resources/js_to_json.js.txt)                   |
| `i18n/json_to_js.js`              | [json_to_js.js](resources/json_to_js.js.txt)                   |
| `i18n/create_scratch_msgs.js`     | [create_scratch_msgs.js](resources/create_scratch_msgs.js.txt) |
...
```js title="scratch-editor/packages/scratch-gui/src/lib/make-toolbox-xml.js"
...
```js title="scratch-editor/packages/scratch-vm/src/blocks/scratch3_looks.js"
// highlight-next-line
...
| ----------------- | --------------------------------- | -------------------------------------------------------- |
| `scratch-blocks`  | `src/blocks/looks.ts`             | [looks.ts](resources/looks.ts.txt)                       |
