...
The newest versions of Scratch 3.0 [have been relicensed](https://scratchfoundation.org/open-source-license) to be under the [GNU Affero General Public License v3](https://github.com/scratchfoundation/scratch-gui/blob/eec78119b42129f6870f6981fa14303ee094e019/LICENSE). This means that, if you are using code from one of these versions and release your mod, you must also release the source code of your mod with it.
...
First, delete the `.github` folder in `scratch-gui`, `scratch-vm` and `scratch-blocks` to prevent the Scratch Team's GitHub Actions running. Next, you will need to commit and push your changes to GitHub.
