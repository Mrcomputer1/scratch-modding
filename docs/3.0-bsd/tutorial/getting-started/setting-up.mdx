...
<DocVersionSwitcher versions={{
    agpl: {
        name: "AGPL",
        path: "../../../3.0/tutorial/getting-started/setting-up",
    },
    bsd: {
        name: "BSD",
        path: "../../../3.0-bsd/tutorial/getting-started/setting-up",
    },
}} active="bsd" />
...
git clone https://github.com/scratchfoundation/scratch-gui.git --depth=1 --branch=v4.1.7
cd scratch-gui
        </CodeBlock>
        This will create a folder called <code>scratch-gui</code> and download <code>scratch-gui</code> inside it. The <code>--branch v4.1.7</code> instructs Git to download the v4.1.7 tag. The <code>--depth=1</code> option instructs Git to only download the specified version and not download the entire history of <code>scratch-gui</code>.
    </TabItem>
    <TabItem value="false" label="Without Git">
        <ol>
            <li>
                <a href="https://github.com/scratchfoundation/scratch-gui/archive/refs/tags/v4.1.7.zip" class="button button--primary">Download scratch-gui</a>
            </li>
            <li>
                Extract the folder inside the ZIP.
            </li>
            <li>
                Rename the folder from <code>scratch-gui-4.1.7</code> to <code>scratch-gui</code>.
            </li>
        </ol>
    </TabItem>
</Tabs>
...
```shell
webpack 5.96.1 compiled successfully in 35110 ms
```
...
<Tabs groupId="use-git" queryString>
    <TabItem value="true" label="With Git" default>
        <strong>Optional Step:</strong> Fork the repository on GitHub and clone your fork instead.<br/>
        <CodeBlock language="shell">
git clone https://github.com/scratchfoundation/scratch-vm.git --depth=1 --branch=v4.8.115
cd scratch-vm
        </CodeBlock>
    ...
    <TabItem value="false" label="Without Git">
        <ol>
            <li>
                <a href="https://github.com/scratchfoundation/scratch-vm/archive/refs/tags/v4.8.115.zip" class="button button--primary">Download scratch-vm</a>
            </li>
            <li>
                Extract the folder inside the ZIP.
            </li>
            <li>
                Rename the folder from <code>scratch-vm-4.8.115</code> to <code>scratch-vm</code>.
            </li>
        </ol>
    </TabItem>
</Tabs>
...
<Tabs groupId="use-git" queryString>
    <TabItem value="true" label="With Git" default>
        <strong>Optional Step:</strong> Fork the repository on GitHub and clone your fork instead.<br/>
        <CodeBlock language="shell">
git clone https://github.com/scratchfoundation/scratch-blocks.git --depth=1 --branch=v1.2.5
cd scratch-blocks
        </CodeBlock>
    ...
    <TabItem value="false" label="Without Git">
        <ol>
            <li>
                <a href="https://github.com/scratchfoundation/scratch-blocks/archive/refs/tags/v1.2.5.zip" class="button button--primary">Download scratch-blocks</a>
            </li>
            <li>
                Extract the folder inside the ZIP.
            </li>
            <li>
                Rename the folder from <code>scratch-blocks-1.2.5</code> to <code>scratch-blocks</code>.
            </li>
        </ol>
    </TabItem>
</Tabs>
