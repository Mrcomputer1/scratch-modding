...
| ----------------- | --------------------------------------------- | ------------------------------------------------------------- |
| `scratch-gui`     | `src/lib/themes/index.js`                     | [index.js](resources/index.js)                              |
| `scratch-gui`     | `src/components/menu-bar/theme-menu.jsx`      | [theme-menu.jsx](resources/theme-menu.jsx)                  |
| `scratch-gui`     | `src/lib/themes/hard-mode/index.js`           | [index-hardmode.js](resources/index-hardmode.js)            |
