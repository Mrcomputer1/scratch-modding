...
### Python 2 <span class="badge badge--secondary">scratch-blocks</span>
`scratch-blocks`'s build script depends on an old unsupported version of Python. The version of Python required is Python 2, the latest version of Python 2 is 2.7.18 from April 2020 and can be found [here](https://www.python.org/downloads/release/python-2718/).
