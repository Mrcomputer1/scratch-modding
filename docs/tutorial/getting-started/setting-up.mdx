...
As of October 25, 2023 (UTC), `scratch-blocks` now supports building with both Python 3 and Python 2. In case you are modding with an older version of `scratch-blocks`, the Python 2 specific information is still available below:
