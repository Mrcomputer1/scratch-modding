...
| ----------------- | --------------------------------- | ----------------------------------------------------- |
| `scratch-blocks`  | `blocks_vertical/looks.js`        | [looks.js](resources/looks.js)                        |
...
| `scratch-vm`      | `src/blocks/scratch3_looks.js`    | [scratch3_looks.js](resources/scratch3_looks.js)      |
