...
| ----------------- | --------------------------------------------- | ------------------------------------------------------------- |
| `scratch-vm`      | `src/extensions/tutorialmod_dialogs/index.js` | [index.js](resources/index.js)                                |
| `scratch-vm`      | `src/extension-support/extension-manager.js`  | [extension-manager.js](resources/extension-manager.js)        |
| `scratch-gui`     | `src/lib/libraries/extensions/index.jsx`      | [index.jsx](resources/index.jsx)                              |
