...
1. The first is the category ID, in this case `13`.
...
To add the block to your new category, simply change the category ID from `2` (looks) to `13` (your new category, Dialogs). You can remove the Stage looks (category `102`) version of your block now.
